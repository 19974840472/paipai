  ...
  return {
    a: common_vendor.f($props.leftOptions, (item, index, i0) => {
      return {
        ...
        g: common_vendor.o(($event) => _ctx.onClickForPC(index, item, "left"))
      };
    }),
    ...
    c: common_vendor.f($props.rightOptions, (item, index, i0) => {
      return {
        ...
        g: common_vendor.o(($event) => _ctx.onClickForPC(index, item, "right"))
      };
    }),
    d: common_vendor.o((...args) => _ctx.appTouchStart && _ctx.appTouchStart(...args)),
    e: _ctx.is_show,
    f: $props.threshold,
    g: $props.disabled
  };
...
if (typeof block1 === "function")
  block1(_sfc_main);
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/xxzl/z/uniapp/paipai/node_modules/@dcloudio/uni-ui/lib/uni-swipe-action-item/uni-swipe-action-item.vue"]]);
