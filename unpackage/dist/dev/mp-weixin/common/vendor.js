...
class Router {
  ...
  async route(options = {}, params = {}) {
    ...
    if (typeof options === "string") {
      ...
      mergeConfig2 = index$1.$u.deepClone(options, this.config);
...
function addUnit(value = "auto", unit = ((_c) => (_c = ((_b) => (_b = ((_a) => (_a = index$1 == null ? void 0 : index$1.$u) == null ? void 0 : _a.config)()) == null ? void 0 : _b.unit)()) != null ? _c : "px")()) {
  value = String(value);
