...
var uni_modules_uviewUi_components_uIcon_icons = require("./icons.js");
var uni_modules_uviewUi_components_uIcon_props = require("./props.js");
const _sfc_main = {
  name: "u-icon",
  data() {
    return {};
  },
  mixins: [common_vendor.index.$u.mpMixin, common_vendor.index.$u.mixin, uni_modules_uviewUi_components_uIcon_props.props],
  computed: {
    uClasses() {
      let classes = [];
    ...
    icon() {
      return uni_modules_uviewUi_components_uIcon_icons.icons["uicon-" + this.name] || this.name;
    }
  },
  methods: {
    clickHandler(e) {
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-2ee87dc9"], ["__file", "D:/xxzl/z/uniapp/paipai/uni_modules/uview-ui/components/u-icon/u-icon.vue"]]);
